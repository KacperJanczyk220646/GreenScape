...
with ethics_overview:
    ...
    st.write(
        "Well, we believe talking about what was NOT included is a much simpler way to go."
    )
    ...
    with text_column1:
        ...
        st.markdown(
            "- [Assessment List for Trustworthy Artificial Intelligence (ALTAI)](https://altai.insight-centre.org/)"
        )
        st.markdown(
...
with ethics_explanation:
    st.write(
        "The core values observed and ensured through answering the DEDA framework are the following:"
    )
