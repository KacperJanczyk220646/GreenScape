...
def main():
    ...
    # Display image
    image1 = Image.open("C:/Users/kacpe/Documents/GreenScape-1/Streamlit/Data/park.png")
    st.image(image1)
    ...
    with tab2:
        st.header("AI Canvas")
        image2 = Image.open(r"C:\Users\kacpe\Documents\GreenScape-1\Streamlit\Data\AI_Canvas.png")
        st.image(image2)

    with tab3:
        st.header("Project's Roadmap")
        image3 = Image.open(r"C:\Users\kacpe\Documents\GreenScape-1\Streamlit\Data\Roadmap_Image.png")
        st.image(image3)
    ...
    with tab4:
        st.header("Our team")
        image4 = Image.open(r"C:\Users\kacpe\Documents\GreenScape-1\Streamlit\Data\Our_team.png")
